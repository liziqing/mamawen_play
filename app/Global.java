import actor.RemindDispatcher;
import actor.Scheduler;
...
public class Global extends GlobalSettings {
    ...
    public void onStart(final Application app) {
        ...
        ctx.scan("controllers", "models", "repo", "service");
        ctx.refresh();

        // This will construct the beans and call any construction lifecycle methods e.g. @PostConstruct
        ctx.start();
        Scheduler.repoManager = ctx.getBean(RepositoryManager.class);
        RemindDispatcher.repoManager = Scheduler.repoManager;
        XmppConnectionManager.initializeConnection();
    }
